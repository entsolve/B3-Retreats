...
('hero.image.wide.src', 'assets/img/hero-wide.webp', 'image'),
...
('haus.shared.image.src', 'assets/img/haus-schlafen.webp', 'image'),
('haus.shared.image.alt', 'Schlafzimmer mit bodentiefem Fenster', 'text'),
...
('haus.friends.image.src', 'assets/img/haus-wohnen.webp', 'image'),
('haus.friends.image.alt', 'Wohnbereich mit Vorhängen und Tageslicht', 'text'),
...
('abschluss.bg.src', 'assets/img/abschluss.webp', 'image'),
('abschluss.eyebrow', 'Be free', 'text'),
('abschluss.headline', 'Be free to be you.', 'text'),
('abschluss.lines', '[{"text": "Vielleicht geht es in diesen vier Tagen gar nicht darum, Antworten auf jede Frage zu finden."}, {"text": "Vielleicht geht es darum, dir genügend Zeit zu geben, damit du die richtigen Fragen überhaupt wieder hören kannst."}, {"text": "Zeit für deinen Körper, deine Gedanken, deine Wünsche und all das, was im Alltag manchmal ein bisschen zu kurz kommt."}]', 'json'),
('abschluss.lines_big', '[{"text": "Und vielleicht fährst du am Sonntag nicht als eine andere Frau nach Hause."}, {"text": "Sondern einfach ein bisschen mehr als du selbst."}]', 'json'),
('abschluss.cta', 'Ich bin dabei', 'text'),
('abschluss.stamp', 'B³ Retreat &middot; 08.–11. Oktober 2026 &middot; Spabrücken', 'text'),
